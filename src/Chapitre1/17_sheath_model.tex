...
\section{Sheath model with electron emission}
  ...
  In \Cref{eq-sheathhobbs,eq-total_drop}, we uses $\Tepar$ as in general, and more precisely for low-pressure magnetized plasma, the electrons can be anisotropic.
