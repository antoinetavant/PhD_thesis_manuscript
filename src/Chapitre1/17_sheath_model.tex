...
\section{Sheath model with electron emission}
  ...
  For xenon, \cref{eq-ratecr} gives $\ratecr = 0.983$ \citep{goebel}.\footnote{This value of 0.983 is obtained after several approximation, as \cref{eq-scl_Er} , some of which should not allow to use three significant digits. That's why it does not exactly match with the numerical results presented in \cref{fig-potential_profile}.}
