...
\section{Numerical implementation of the Particle in cell simulation}
  ...
  \label{subsec-poissonintro}
    ...
    In practice, we uses {\sc Hypre}'s multigrid solver to solve Poisson equation in \ac{2D} in \LPPic \citep{falgout2002}.
    
    \inlinenote{Le style du discourd est inconsistant... Trop précis, ou pas access.}
