...
\section{Axial Convection model}
  ...
  \subsection{Effect of the noise on the electric field}
    ...
    \subsection{Noiseless convection model}
      ...
      \inlinenote{A reformuler ! Trop negatif}
      ...
      On the other hand, it is useful to have a longer azimuthal length to study the instability, as it allows to obtain a more resolved wavenumber spectrum.
