...
\section{Axial Convection model}
  ...
  \subsection{Effect of the noise on the electric field}
    ...
    \subsection{Effects on a \ac{2D} simulation domain}
      ...
      \nomenclature[N]{Dirichlet Boundary condition}{ Type of boundary conditions for which the field is fixed. For instance for grounded electrodes on the plasma potential: $\phi = 0$}
