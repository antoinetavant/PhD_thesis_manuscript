...
Because of the number of contributors, and our relative experience in Fortran, we quickly set a Continuous Integration (CI) pipeline on a self hosted server using Teamcity.
