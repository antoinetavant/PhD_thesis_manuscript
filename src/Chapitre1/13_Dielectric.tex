...
\section{Dielectrics boundary condition}
  ...
  \end{equation}
  with $J_i$ and $J_e$ the ion and electron flux respectively, $e$ is the elementary charge, and supposing that there is no surface charge at the interface at the beginning.
  ...
  Therefore, the dielectric layer does not need to be induced in the simulation domain.
