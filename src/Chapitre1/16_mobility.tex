...
\section{Study of electron cross field transport with a 2D radial-azimuthal PIC simulation}
  ...
  \inlinenote{Anne: Revoir la transition, et mettre ici que les calcules numerique. L'état de l'art peut être ajouter au ch_0.}
...
A key topic of my PhD work is to study the impact of surface processes on the plasma discharge and in particular on the electron mobility. }
  ...
  \inlinenote{Anne: je mettrai une grande partie du texte de cette page dans le chapitre 0 et je rappellerai ici juste les expressions de mu_eff, mu_classic, mu_sat...et dire en 2 phrases comment ils sont calculés en PIC.}
