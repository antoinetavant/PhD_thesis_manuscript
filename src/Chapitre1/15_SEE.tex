...
\end{figure}
 ...
 Since the model used describes both the reflected and true secondary electron emission, we will use the general name \emph{electron emission}  to refer to the flux of electron coming from the wall toward the plasma.
