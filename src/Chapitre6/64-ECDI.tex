...
%   \caption{\ac{2D} and \ac{1D} \ac{FFT} of the azimuthal electric field in the downstream region $z=z_d$ without radial losses.  The black dotted lines highlight the position of the maximum of the \ac{2D} \ac{FFT}, and the red dashed line corresponds the \ac{IAW} dispersion relation of \cref{eq-MIAW}.}
...
\end{figure}
\inlinenote{Wrong units, and add titles for the column}
