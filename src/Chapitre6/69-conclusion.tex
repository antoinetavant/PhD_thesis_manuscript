...
The reduced wave amplitude is related by a reduce of the ion-wave trapping, which seems to be one of the dominant mechanism of saturation when the radial losses are not modeled.
In addition, the characteristics of the wave (frequency, wavelength) are modified.
More precisely, the upstream region, close to the maximum of the magnetic field, the waves are not affected.
