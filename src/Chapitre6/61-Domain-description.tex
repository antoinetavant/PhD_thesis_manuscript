...
The electrons emitted by the cathode are injected inside the simulation domain, at 1\,cm from the boundary.
...
We do not model the secondary elecobjectivetron emission.
