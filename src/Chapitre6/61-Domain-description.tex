...
Two other approaches have been followed to reduce the computational cost induced by the breathing mode\string:
\begin{enumerate}
...
\inlinenote{Plutôt referencer le benchmark Charoy et al. ?}
% 
...
\begin{figure}[hbt]
  ...
  \end{tabular}
  \caption{(left) the \acs{2D} axial azimuthal domain\string; (right) the axial profile of the magnetic field and the ionization source term profiles used for the simulation case of \citet{boeuf2018}. }
