...
\subsection{Simulation test-case of Coche} \label{subsec-boeuf_description}
...
\begin{align}
  ...
  \deriv{n_g v_g}{t} &+ \deriv{n_g v_g^2}{z} +  \deriv{2 n_g D_g}{z} = - S_{iz} v_g
\end{align}
...
\end{equation}
The gas temperature $T_g=300K$ and the initial condition is described on the density $n_g$ on \cref{fig-coche-presnetation}(right).
