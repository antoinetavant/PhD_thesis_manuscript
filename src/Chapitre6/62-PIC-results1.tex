...
\section{Results of the axial-azimuthal PIC simulations}
  ...
  \subsection{Simulation results\string: temporal evolution} \label{subsec-temp_boeuf}
    ...
    \begin{figure}[hbt]
      ...
      \end{tabular}
      \caption{Temporal evolution of ({\bf a})  the mean plasma density, and  ({\bf b}) the  mean (solid line) total electron temperatures temperature $\Te$  and (dashed line) the radial temperature $\Te_{,R}$ in the axial-azimuthal simulations, obtained with three different radial models. }
