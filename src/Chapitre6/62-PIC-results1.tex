...
\Cref{fig-boeuf-temporalMCC} shows the temporal evolution of the mean electron kinetic energy of the left, and on the right it shows the axial profile of the electron temperatures, decomposed on the three directions.
