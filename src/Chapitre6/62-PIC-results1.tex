...
\inlinenote{Anne: un peu rapide: redire qu apres une phase transitoire, un etat stationnaire est atteint au bout de XXX microsecondes. Donner une table ou faire reference au papier de Thomas pour donner toutes les caracteristiques de tes simulations
