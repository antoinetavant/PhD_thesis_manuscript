...
\inlinenote{Anne: un peu rapide: redire qu'après une phase transitoire, un etat stationnaire est atteint au bout de XXX microsecondes.
Donner une table ou faire reference au papier de Thomas pour donner toutes les caracteristiques de tes simulations

Si quelqu'un essaie de refaire tes calculs de thèse, on doit avoir les informations pour les refaire ;-)
}
...
\inlinenote{Anne: Phrase ambigue\\ tu ne commentas pas du tout les resultats avec Lr=2 et 4cm}
...
\inlinenote{Anne: tu as dit quelquepart que tu mettais des pertes radiales pour toutes les valeurs de z et pas seulement dans le canal?}
...
\inlinenote{Anne: je ne vois pas ou tu parles de cette figure dans le texte...}
...
\end{figure}
\inlinenote{Anne: Ca fait bizarre de voir la courbe orange que s'arrete avant les autres a 2.3cm, au moins le mentionner dans le texte ou simplement dans la legende sous la figure}
