...
\section{Comparison of the \ac{DR} with the \ac{PIC} simulations}
  ...
  \subsection{Resolution of the electron cyclotron drift instability} \label{subsec-ECDIPIC}
    ...
    \begin{figure}[!hbt]
      ...
      \caption{Comparison of the \ac{2D} \ac{FFT} of the azimuthal electric field FFT$(E_{\theta})$ with the following \ac{DR}\string: (orange solid) \ac{ECDI} general \ac{DR} obtained with the \ac{PIC} \ac{EVDF}; (dotted red) \ac{ECDI} \ac{DR} obtained with the Maxwellian hypothesis; and (dotted blue) \ac{IAW} \ac{DR} using the analytic expression \cref{eq-MIAW}.   }
