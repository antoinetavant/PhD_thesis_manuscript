...
\section{Comparison of the \acs{DR} with the \acs{PIC} simulations}
  ...
  \subsection{Resolution of the electron cyclotron drift instability} \label{subsec-ECDIPIC}
    ...
    \inlinenote{Fig 2.17: give the time over with the FFT is computed. Idem, check problem $\omega_r$}
    \begin{figure}[!hbt]
      \centering
  ...
  \inlinenote{What about the ion landau damping ? Cf Work of Roberto}
