...
\section{Dispersion relation of the instabilities}
  ...
  \subsection{Modified Ion Accoustic Wave}
    ...
    However, kinetic simulations in \citet{janhunen2018,taccogna2019} have show that after some time (around  $t=0.5\,\micro\second$ and $t=3\,\micro\second$ respectively) the resonances are not present, with a progressive decrease of the higher harmonics and the first harmonics becoming the most prominent .
    This observation is attributed to non-linear resonance broadening, because the electron orbit est distorted, leading to the loss of the phase relation between the electron and the wave \citep{taccogna2019}.
    ...
    \end{split}
    \end{equation}
    \Cref{eq-drIAWgene} is the general Ion Accoustic Wave dispersion relation.
