...
\section{Radial boundary conditions}
  ...
  \Cref{fig-ratio} shows that the ration $\delta \phi / <\phi>$ is almost constant in the plasma, except close to the wall, where the plasma potential decrease much faster than the oscillations.
  The same behaviour can bee observed in the profiles of the ion density, that can bee seen in \Cref{fig-ion_oscilation}.
  ...
  We have see in \Cref{ch-2} that the dielectric boundary did not affect the simulation.
  \Cref{fig-closswallosci} shows the radial evolution in the first cells of the amplitude of the oscillation of the azimythal electric field on the left, and and the ion density on the right, with grounded (metallic) wall and dielectric wall.
