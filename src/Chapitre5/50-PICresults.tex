...
\section{Instability in the \ac{PIC} simulation}
  ...
  \paragraph{Ion trapping oscillation\\}
    ...
    In \citet{janhunen2018}, the authors present a collision-less highly results \ac{2D} \ac{PIC} simulation.
    No convection, and no radial losses compensation model are used, hence the electron energy quickly rises and the density decreases.
    ...
    In these conditions, the instability rises, but a large structure, named a Modified Two Stream Instability (MTSI), is observed, of wavelength twice as big as $L_r$.
    ...
    The results are qualitatively similar to the others, but in this case, the author observed radial structures, but this time with a wavelength of a third of $L_r$.
    
    \inlinenote{Comment conclure sur ces results ??}
