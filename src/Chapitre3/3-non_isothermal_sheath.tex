...
\Cref{ch-2} has showed us a discrepancy between the expected plasma-wall interaction, as the plasma potential drop thought the sheath and the electron emission rate, and the \ac{PIC} simulation results.
