...
\label{sec-MCM}
  ...
  \inlinenote{Reclarifier tout cette section pour bien mettre en avant l'objectif, ce que je fais ensuite dans les autres sections.}
    ...
    \Cref{fig-EEPF_start_end} shows the expected EEPF obtained in the \ac{PIC} simulation with a background pressure of $P=100$\,mTorr.
