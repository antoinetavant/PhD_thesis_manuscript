...
\section{Insights from the PIC simulations}
  ...
  \subsection{Electron distribution function}
    ...
    We can see that the sheath population is colder than the population at the center.
    This observation was not expected, and could explain the difference of \cref{fig-seeparamesMaxw}. 
