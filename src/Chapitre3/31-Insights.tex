...
\section{Insights from the PIC simulations}
  ...
  \subsection{Electron distribution function}
    ...
    \inlinenote{Big misunderstanding here on the effect of the EVDF}
    ...
    \inlinenote{Anne: give here some values (either for the one case given in fig, or the 3 cases).}
   ...
   \inlinenote{Donner les valeurs de Te\_wall mesurer \? }
