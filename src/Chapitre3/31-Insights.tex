...
\section{Insights from the PIC simulations}
  ...
  \subsection{Electron distribution function}
    ...
    Using the kinetic information of the PIC simulations, we present in \Cref{fig-EEDF} the mean electron energy probability functions (EEPF) in the case $\crover = 200\,\volt$, for which the electron emission is of the order of $\rate=0.6$.
