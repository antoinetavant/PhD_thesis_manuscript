...
\inlinenote{Anne:  j'ai l'impression que tu pourrais rajouter quelques phrases avec des references ici pour expliquer "qu'est ce qui est compris et pas compris". 
Si je caricature, en lisant ton paragraphe, tu n'expliques pas pourquoi c'est important de travailler sur ca maintenant ;-)
Il y a eu plein de chose depuis Meezan...tu peux mentionner ici le travail de Jorns.}
\inlinenote{Anne: si tu regades tes deux autres paragraphes suivants, tu justifies mieux ce que tu fais dans cette these par rapport a la connaissance actuelle ;-) Il suffit juste de rajouter 1 phrase ou 2 ici ;-)}
\inlinenote{Anne: voir note page 45, je pense que tu peux ramener une partie du texte ici et y faire reference dans le chapitre 1. Il te suffira de rappeler dans le chapitre 1 les expressions que tu utilises et comment "techniquement" tu les calcules en PIC}
