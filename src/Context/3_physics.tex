...
% \addcontentsline{toc}{subsection}{Plasma-wall interaction}
  ...
  This allows to obtain a flux of electrons equal to the flux of ions, resulting in charge conservation in the plasma, and a neutral flux, or also named zero-net current, to the surfaces.
