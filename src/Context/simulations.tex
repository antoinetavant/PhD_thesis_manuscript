...
The plasma is the state of matter in which atoms are ionized.
...
It is also common to neglect inertia terms and assume a steady state of momentum equations, leading to the drift-diffusion approximation
