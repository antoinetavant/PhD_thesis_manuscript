...
\subsection{Hall Effect Thruster operating principle}
% \addcontentsline{toc}{subsection}{HET operating principle}
  ...
  On average in a well designed \ac{HET}, 90\% of the propellant is ionized.
 ...
 \nomenclature[P]{\ensuremath{ \atomicmass}}{ Atomic mass, \nomunit{$1\, \atomicmass \simeq \sn{1.66}{-27} \,\kilo\gram$}}
 \nomenclature[Q]{\ensuremath{ U_d}}{ Discharge voltage}
  ...
  \subsection{Instabilities present in the Hall Effect Thruster }
  \label{sec-physics}
  ...
  Indeed, a simple predator-prey model of two equations is enough to obtain the observed behavior qualitatively.
