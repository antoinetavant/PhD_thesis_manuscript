...
\addcontentsline{toc}{section}{HET operating principle}
...
\addcontentsline{toc}{section}{Electron drift and azimuthal instability in the HETs}
...
\section*{Three-dimensional physics of the HET}
  \label{sec-3Dphi}
  \addcontentsline{toc}{section}{Three-dimensional physics of the HET}
