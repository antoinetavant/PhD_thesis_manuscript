...
\section{Presentation of study}
  ...
  \emph{This study is based on the preliminary work of V. Croes, which he presented in his Ph.D. thesis \citep{croes2017}.
  Based on these results, I continued the analyze which has been published in  \citet{tavant2018}.}
\end{Chabstract}
  ...
  As highlighted in the introduction and in \cref{ch-5}, the \ac{ECDI} rises due to the $E \times B$ electron drift, but saturates due to both to the axial convection model which limits the electron heating, and the ion-wave trapping.
