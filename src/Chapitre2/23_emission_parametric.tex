...
\section{Effect of electron emission}
 ...
 Consequently, we observe a few oscillations before the steady-state is reached, as these cases are close to the bifurcation.
   ...
   The sheath is unstable, and quickly attain a \ac{SCL} regime \citep{raitses2005}.
   
   In this regime, the sheath is not monotonic, and the model of \vref{eq-sheathhobbs} is no more value, and the potential drop tends toward $\dphi \simeq \Te$ \citep{hobbs1967,goebel2008} \footnote{see \vref{sec-sheath} for more details}, showed in \cref{fig-dphivsTe}.
   ...
   The second point will be studied in \cref{ch-3}
