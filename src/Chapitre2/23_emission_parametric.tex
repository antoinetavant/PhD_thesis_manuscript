...
\section{Effect of electron emission}
  ...
  \Cref{fig-see_illustration} shows the electron emission probability for $\crover=35.04$~V superimposed to a Maxwellian \ac{EEDF} of temperature $\Te=45$~V.
 ...
 Consequently, we observe a few oscillations before the quasi steady-state is reached, as these cases are close to the bifurcation.
   ...
   We can try and predict the threshold value of $\crover$ between regimes {\bf III} and {\bf II}.
   ...
   The evolution of the temperature with  $\rate$ is shown latter in \cref{fig-Tevsproba}.
   ...
   Hence, the cause of the difference if the threshold value for regime {\bf II} will be discussed again in \cref{ch-4}, using a modified plasma-wall interaction model.
