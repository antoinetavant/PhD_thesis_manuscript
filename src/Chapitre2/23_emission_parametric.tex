...
\section{Effect of electron emission}
 ...
 Consequently, we observe a few oscillations before the quasi steady-state is reached, as these cases are close to the bifurcation.
  ...
  \inlinenote{Pas claire, mieux introdure le raisonnement Voir les corrections de Pascal}
   ...
   Consequently, even if $\Te$ does indeed decrease when increasing $\crover$, it remains too large compared to the observations of \cref{fig-dphivsTe}.
   Hence, the cause of the difference if the threshold value for regime {\bf II} remain unknown for now.
   It will be discussed again in \cref{ch-4}, using a modified plasma-wall interaction model.
