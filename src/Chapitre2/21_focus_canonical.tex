...
\section{The base case}
  ...
  Hence, there is no need to simulate for times longer than $10\mus$ in the following simulations.
  ...
  The plasma is mostly quasineutral, except close to the walls.
