...
\section{Canonical simulation results}
  ...
  The {\it canonical} case corresponds to the case when the wall do not include its dielectric mechanism\string:
  \begin{itemize}
  ...
  \begin{figure}[hbtp]
    ...
    \caption{Azimuthal instability\string: temporal evolution of the azimuthal electric field at the center of the simulation, and its frequency spectra }
