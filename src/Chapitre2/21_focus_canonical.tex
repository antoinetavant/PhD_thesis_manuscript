...
\section{The base case}
  ...
  The oscillations are then damped and reach their minimum amplitude at  $t\simeq 7\mus$ and then remain with a small amplitude as shown on simulations carried out up to $25\,\micro\second$ on \cref{fig-canon_Te_all} (the origin of these oscillations has been discussed in \Cref{subsec-temp}).
  ...
  In the sheath, close to the wall, the electron density falls more rapidly compared to that of ions.
