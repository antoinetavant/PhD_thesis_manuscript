...
\section{Canonical simulation results}
  ...
  \Cref{fig-profiles} shows the radial profiles of the electron and ion densities averaged azimuthally at steady state.
  ...
  \inlinenote{Anne: formule pas deja ecrite avant? \\Réponse: Si. Est-ce grave ? }
  ...
  \inlinenote{Anne: peut-etre trop affirmatif, non? tu peux peut-etre a ce stade laisser une chance aux autres instabilités et ensuite dire que dans ton cas, avec l'ECDI seulement c'est OK ?}
  % K_ex = 2 10^-13
  % n_g = 1e19
  % wce = q B / m
  The oscillations can bee seen in \cref{fig-2dschemat}, that displays the azimuthal electric field featuring the oscillation of wavelength of the order of 1~mm, as observed in \citet{heron2013,janhunen2018}.
  \Cref{fig-exampleECDI} shows the temporal evolution of the azimuthal electric at the center of the channel.
  ...
  The \ac{ECDI} instability is the subject of \Cref{ch-5}, hence it will not be further investigated here.
  ...
  \inlinenote{Anne: pour preparer ce que tu vas montrer sur la figure 2.11, je pense qu'il faut que tu donnes ici les différentes valeurs des différentes mobilités pour epsilon=0}
