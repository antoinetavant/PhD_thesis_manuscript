...
\section{Validation of the sheath model }
  ...
  We can see in \Cref{fig-seeparamesMaxw} that the mean electron emission rate in the simulations $\ratepic$ lies between 0.6 for large $\crover$ and 1 at low $\crover$.
  ...
  \begin{figure}[hbt]
    \centering
    \begin{tabular}{@{} cc}
      \includegraphics[width=0.49\textwidth]{phi_drop_6}
      &
      \includegraphics[width=0.49\textwidth]{Te_pic_2}
    \end{tabular}
