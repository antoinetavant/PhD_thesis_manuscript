...
\inlinenote{Add references to Vivien these (think about the best way)}
\inlinenote{Add reference to Article }
...
\input{Chapitre2/22_dielectric_layer}
\input{Chapitre2/23_emission_parametric}
\input{Chapitre2/24_parametric_sheath}
\input{Chapitre2/25_diel_and_SEE}
