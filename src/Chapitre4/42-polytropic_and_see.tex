...
\inlinenote{Anne: je rajouterai ici une sous-section avec la discussion sur les Te1 et Te2 que tu mets actuellement dans la section 4.3.3
Je pense que tu pourrais garder dans 4.3.3 juste la comparaison avec Raitses, tes resultats PIC et le cas isotherme.}
...
\end{figure}
\inlinenote{Anne: Normalized pour les 2 axes des x}
