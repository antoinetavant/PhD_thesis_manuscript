...
\inlinenote{repreciser en 1 phrase les conditions de simulation (en faisant reference au chapitre 3) + citer section ou tu parles de l'emission (penser au lecteur qui commence la lecture au chapitre 4)}
\inlinenote{pourquoi pas montrer une image de calcul 2D....a force de voir que des resultats 1D, on va finir par oublier que ton code PIC est 2D ;-)}
...
%\unsure{Is it the center or the sheath-edge ?}
