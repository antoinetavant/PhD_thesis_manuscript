...
\section{Polytropic electrons in the presence of \ac{SEE}}
\label{sec-PIC_poly}
...
\ra{1.3}
  \centering
  \caption{Polytropic index extracted from the \ac{2D}  \ac{PIC} simulations}
...
\begin{equation} \label{eq-vlasov}
  ...
  \end{dcases}
\end{equation}
The results obtained by the system of equations (\ref{eq-vlasov}) are compared to the mean density and temperature measured in the \ac{PIC} simulations in \cref{fig-evdf_polyfit}.
