...
\section{Comparison of the sheath model with PIC simulations} \label{subsec-picandmodel}
  ...
  \subsection{Sheath oscillations of regime {\bf II}} \label{subsec-pic_scheath_RSO}
    ...
    More precisely, the radial temperature $\Te_{,R}$ is linked to the thermal flux of electron toward the wall, while the total temperature $\Te$ is used in the computation of the electron emission rate $\ratemaxw$.
    ...
    Is also shown the theoretical solutions obtained with the model of \cref{sec-fluid_poly_see} using a constant polytropic index $\gamma=1.35$ and $1.28$, and $\crover=45\,\volt$, using a pre-sheath potential drop of $\Teb/2$.
    ...
    The total electron power balance can be expressed as
    ...
    The absorbed power $P_{\rm abs}$ is mainly the Joule heating
