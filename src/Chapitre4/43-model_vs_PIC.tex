...
\inlinenote{Anne: comme dit deja : il faut que en debut de chapitre, tu précises bien les conditions de tes simulations PIC.}
  ...
  \subsection{Sheath oscillations of regime {\bf II}} \label{subsec-pic_scheath_RSO}
    ...
    \begin{figure}[hbtp]
      ...
      \label{fig-long_time}
    \end{figure}
    \inlinenote{Anne: define the two electron temperatures in the caption}
    ...
    \inlinenote{Ha bah en fait non ! Voir avec le temps pour le temps de formation de la pres-gaine via le time-of-flight des ions. \\ Anne: a rediscuter....je pense que l'hypothèse stationnaire peut effectivement etre utilisée pour expliquer les ecarts}
